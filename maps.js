...
function toggleOverlay(){
    ...
    if(showingOverlay){
        /* Show overlay */
        document.getElementById("overlay-insert").innerHTML = '<div id="overlay"> <span class="option">Toggle grid <input type="checkbox" checked="true" onclick="toggleGrid(this.checked)"></span> <span class="option">Show midpoints <input type="checkbox" checked="true" onclick="showMidpoints(this.checked)"></span> <span class="option">Select map: <select id="selection" oninput="changeMap(this.value)"> <option value="https://mrfortnite.ml/images/S8_MAP.jpg">Season 8 1k</option> <option value="map.jpg">Season 4 1k</option> <option value="s3-1k.jpg">Season 3 1k</option> <option value="8000xmap.jpg">Season 4 8k</option> <option value="s3-8k.jpg">Season 3 8k</option> </select></span> <span class="option"><a href="javascript:deleteCurrentPoint()">Delete highlighted point</a></span> <span class="option"><a href="https://github.com/Yogsther/fortnite-maps" target="_blank">Fork me</a></span> </div>';
    } else {
        /* Hide overlay */
